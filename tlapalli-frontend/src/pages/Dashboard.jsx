  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-start">
              <button 
                ...
                className="bg-white/10 hover:bg-white/20 text-white border border-white/10 hover:border-white/20 font-bold px-4 py-2.5 rounded-xl transition text-xs flex items-center gap-2 shadow-lg"
              >
                <Download size={14} />
      ...
      <div id="print-section">
        ...
        <div className="p-16 relative min-h-[1050px] flex flex-col justify-between text-neutral-800 bg-white select-text">
