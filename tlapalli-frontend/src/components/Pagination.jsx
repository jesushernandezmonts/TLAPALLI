function Pagination({ currentPage, totalPages, startIndex, itemsPerPage, filteredLength, onPageChange }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border border-white/10 bg-slate-950/80 px-5 py-4 shadow-lg shadow-black/20 backdrop-blur-md">
